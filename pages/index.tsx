...
export default function HomePage() {
  ...
  const fullName = 'Himanchal Kaushale';
  ...
  const codeLines = [
    ...
    { code: "    name: 'Himanchal Kaushale',", type: 'array-item' },
      ...
      <div className={styles.container}>
          ...
          <div className={styles.codeContainer}>
            <div className={styles.macControls}>
              <div className={styles.macButtons}>
                <span className={styles.macButton} style={{ backgroundColor: '#ff5f56' }}></span>
                <span className={styles.macButton} style={{ backgroundColor: '#ffbd2e' }}></span>
                <span className={styles.macButton} style={{ backgroundColor: '#27c93f' }}></span>
              </div>
              <div className={styles.windowTitle}>Himanchal Kaushale - Visual Studio Code</div>
            </div>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            {typedText.split(' ')[0]} <span className={styles.accentText}>{typedText.split(' ')[1] || ''}</span>
